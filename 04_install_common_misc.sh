...
### set fish colors
fish -c "set -U fish_color_autosuggestion '555'  'brblack'"
...
fish -c "set -U fish_color_search_match --background=111"
...
fish -c "set -U fish_pager_color_description 'B3A06D'  'yellow'  '-i'"
fish -c "set -U fish_pager_color_prefix 'cyan'  '--bold'  '--underline'"
