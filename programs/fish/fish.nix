...

{
  ...
  home.file.".config/fish/conf.d/app_misc.fish".source = ./conf.d/app_misc.fish;
  ...
  home.file.".config/fish/conf.d/dev.fish".source = ./conf.d/dev.fish;
  home.file.".config/fish/conf.d/dev_flox.fish".source = ./conf.d/dev_flox.fish;
  ...
  home.file.".config/fish/conf.d/devops_security.fish".source = ./conf.d/devops_security.fish;
  home.file.".config/fish/conf.d/devops_system.fish".source = ./conf.d/devops_system.fish;
  home.file.".config/fish/conf.d/devops_terraform.fish".source = ./conf.d/devops_terraform.fish;
