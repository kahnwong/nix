...

{
  ...
  home.file.".config/fish/conf.d/app_gcal_tui.fish".source =
    ./conf.d/app_gcal_tui.fish;
  ...
  home.file.".config/fish/functions/get_fish_secret.fish".source =
    ./functions/get_fish_secret.fish;
